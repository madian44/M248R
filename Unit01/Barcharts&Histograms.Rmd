---
title: 'M248: Barcharts & Histograms'
author: "David Thomas"
date: "09/10/2020"
...
## Introduction
This notebook is my attempt to reproduce the Minitab exercises from Unit 01 of the Open University statistics module M248, Analysing Data. Categorical data can be displayed with a bar chart and continuous data can be displayed with a histogram. The datasets used by M248 in this unit are tattoos.mwx and workforce.mwx respectively. R cannot directly import Minitab files so I have converted them to similarly named CSV files.
...
That's it for barcharts. Onwards ...
